...
Rule: Read `docs/agent/STATE.md` and `docs/WAITING_ON_YOU.md` only when a task, a prompt or the owner calls for them; current work is pull, never session-start reading. [A3: pass]
