...
description: Write or revise a Relaunched Fix Pack prompt or job brief for another session — short and decisive, with a live work list, scope, stops and a declared lifecycle.
---
...
- **Investigation or fix build** (find a bug's cause, design or build its repair): give the evidence
