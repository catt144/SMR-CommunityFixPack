return PlaceObj('ModDef', {
	...
	'last_changes', "- An Earth-sent Trade rocket (most often the Wildfire mystery's cure rocket) could get stuck on the landing pad forever if its fuel cost changed while it waited there — finishing Advanced Martian Engines research is the reported trigger. The fuel request is now resized when that happens, and a rocket already stuck like this in your save is corrected the moment you load it.\n- An Advanced Orbital Probe fired without Adapted Probes no longer knocks an already deep-scanned neighbouring sector back to merely \"Scanned\".\n- Both were watched working in a running colony on game 1.1.0.",
