return PlaceObj('ModDef', {
	...
	'last_changes', "Three new fixes, all watched working in a running colony on 1.1.0, and three retired:\n\n-Clogged after a Dust Storm — NEW. A building switched off by a dust storm could say \"Clogged after a Dust Storm.\" and never start again, with destroy and rebuild the only way out. It is switched back on now, and one already stuck in your save recovers the next time you load it.\n\n-Building Codes — NEW. The law now applies to buildings deployed from prefabs, as its description says. It covers buildings completed after this update; the game does not record that a finished building came from a prefab.\n\n-Faction dome size — NEW, and a judgment call. Four of the five factions counted any dome, however small, when deciding they disliked its unemployment or homelessness — one idle colonist in a dome of three was enough. All five now use the ten-colonist rule the fifth already had.\n\n-Three fixes RETIRED. 1.1.0 handles the salvaged-farm oxygen leak and the layout research check itself, and the cave-in map fix repaired a situation that cannot arise. With the three above added, the fix list stays at forty-nine.",
	...
	'code', {
		...
		"Code/Fix_WildfireCureMigration.lua",
		...
		"Code/Fix_BuildingCodesPrefab.lua",
