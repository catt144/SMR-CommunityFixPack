return PlaceObj('ModDef', {
	...
	-- ⭐ REWRITTEN 2026-09-18 for v13 (`release_prompt.md` §1). ⛔ NOT APPENDED — v12's note above
	-- is posted on both stores. One entry, C107: its kit probe PASSED in game on new research, across
	-- a save/reload and on a pre-fix save (owner, 2026-09-18), so it says "checked in a running
	-- game" — not "watched working", since nobody watched a farm's water figure drop. Count
	-- re-derived: `grep -c '^??? ' content/fix-list.md` = 54.
