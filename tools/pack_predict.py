...
IGNORE below is a literal copy of metadata.lua's `ignore_files`, in order;
doccheck's PACK IGNORE PARITY gate fails when the two disagree.

⛔ JUNCTIONS AND SYMLINKS. The engine's recursive listing walks through a
directory junction as if it were a folder. 2026-09-16: a junction to the
user's Claude projects folder inside the mod folder put ~1.2 GB of private
...
CONTENT_PREFIX = "AppData/Mods/SMR_CommunityFixPack/"
