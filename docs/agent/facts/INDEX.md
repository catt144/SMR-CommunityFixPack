...
observation (30 of 52 state one) — a mechanical extraction, not an
...
| EF-051 | Steam Cloud RESTORED deleted savegames at launch, which is why the save-dir close-out gate 'failed' twice. ✅ CLOSED 2026-08-11: two post-untick launches restored NOTHING and every directory delta reconciles by name — the WORKFLOW 'never say gone' caveat is RETIRED (corun-pt15 terminal audit); a returning stray re-opens this fact. ⚠️ Baselines must be recorded as NAMES, never a count | 2026-08-11 | 2026-08-11 | 124 | [EF-051.md](EF-051.md) |
