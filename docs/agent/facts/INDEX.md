...
| EF-051 | Steam Cloud RESTORES deleted savegames at launch — an agent-side deletion with the game closed does not survive the next start, which is why the save-dir close-out gate 'failed' twice | 2026-08-11 | 2026-08-11 | 58 | [EF-051.md](EF-051.md) |
