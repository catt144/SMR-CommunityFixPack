...
Moved verbatim out of `docs/agent/WORKFLOW.md` 2026-09-12 (owner decision D5): a *situational* procedure does not belong in the *standing rules* doc. Still BINDING when it applies. The sign-off tiers that were filed at the end of this section stayed behind in `WORKFLOW.md` — they are standing policy for every leg, not a co-run rule.
