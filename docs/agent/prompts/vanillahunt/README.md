...
| 03c | `03c_PROGRESS_SEAM.md` | Fable (rec) | no |284 hand rows +2 CALLERS: research/tech, factions/laws, missions and progression |
| 03d | `03d_CALLER_SEAM.md` | Fable (rec) | no |249 hand rows +16 CALLERS +18 NOROWS: remaining base callers/services/resource/maintenance seams |
