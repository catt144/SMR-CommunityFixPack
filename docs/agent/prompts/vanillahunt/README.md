...
| ~~04~~ | ~~`04_HUNT.md`~~ | **Codex Sol Ultra** (owner-assigned 09-10) | no | **DONE 2026-09-10:** owner-rescoped skim 944/944 file/registry/list units; 14 ranked drill bundles; controls 4/4; C78-C81 cand/source-read, C62 route amended; reports in `reports/vanillahunt/agents/`; no child queue. FR-1/2/3 remain open; 99 is next. |
| ~~99~~ | ~~`99_TERMINAL_AUDIT.md`~~ | Fable | — | ✅ **DONE 2026-09-10** (`smr-bugfixpack-f8`) — verdict **SOUND WITH STATED GAPS** (instruments; one gap newly measured: 1,281 table-level hunks in 368 rowed hand files, listed by nothing but 04's file skim); controls upheld (seeds 4/4 by content, blind 17/20 routing, 0 hidden churn); all 12 P2 entries re-derived from the trees: **6 HOLD / 5 WEAKENED / C80 REFUTED**, R08311 rejection stands; **C82** filed by the audit; FR-1/2/3 open; ck142 routed; report **`reports/vanillahunt/HUNT_AUDIT.md`**, whose §8 is the `DLC_DEEP_CHECK.md` kickoff line. Grave `git show f8bdb2b:docs/agent/prompts/vanillahunt/99_TERMINAL_AUDIT.md` |
