...
| `C96_LIVE_FAILURE.md` | `prompt` | **LIVE, NOT FIRED — authored 2026-09-16.** C96's repair is REGISTERED IN v11 AND INERT: an attended sitting proved a Seeker-only ESA colony still cannot send a Commander-requiring expedition with the module active, every hook confirmed installed on the class the rocket dispatches through. Carries the seven live measurements, the four refuted diagnoses (including the C95 flattening shape, which does NOT apply), the unhooked third gate, the owner's own "let it be both" design question, and a measured one-line route to spawn the anomaly. ⛔ The ck185 (b) ship ruling predates this evidence — surface it, do not re-rule it. |
