...
| `GAMEPATCH_1_1_1_FIX_fanout_level_3.md` | `prompt` | 1.1.1 follow-up: repair the three surviving modules (legacy Clogged migration; track-salvage rebase, which also retires `Fix_BrokenTrackSalvage`; vacuum/multi-leg migration rebase), with independent integration audit. Adjudicated 2026-09-23; the full-body ranking is `reports/FULL_BODY_PRIORITY_2026-09-23.md` |
| `GAMEPATCH_1_1_1_REMOVE_medium.md` | `prompt` | 1.1.1 follow-up: retire the fifteen modules replaced by native fixes. Adjudicated 2026-09-23: Open Pasture gate cleared on the retail on-leg, trade-rocket enrolment settled at the desk, `Fix_BrokenTrackSalvage` moved to the FIX brief and `Fix_FounderTraitNotification` (F126) added |
