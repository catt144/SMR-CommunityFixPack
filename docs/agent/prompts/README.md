...
|---|---|---|
| `hubset/` | `live` | authored 2026-09-24: builds, verifies and audits the hub release set (C114-C117, C42, C111, F127, P3) as one release, on a `hubset` branch in its own worktree; one attended sitting only (07), preloaded in SMRTK |
