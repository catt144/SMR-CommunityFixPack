...
| `C95_RETURN_HOME_EXPLORATION.md` | `prompt` | **LIVE, authored 2026-09-16** (owner ask): the owner reopened C95's repair shape. Exploration with wide licence, game launch allowed: can habitat residents stay in the expedition draft and come home to their own habitat, even at the cost of a full-body replacement? Report plus an unshipped prototype; nothing lands in `Code/` |
