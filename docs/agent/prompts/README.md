...
| `C95_PLACE_HOME_BUILD.md` | `prompt` | **LIVE, authored 2026-09-17 at the owner's ruling.** Rebuild C95 so habitat residents are drafted like anyone and a returnee whose held habitat is out of reach is placed home, as directly as boarding took them; the draft's route gate retires. Owner's condition: Earth arrivals must provably be untouched. Supersedes the current build's ck200 gates 1–2; release waits on it. |
