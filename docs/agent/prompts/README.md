...
| `MOVE_OPTIN_AUDIT_high.md` | `prompt` | ⭐ **LIVE, NOT FIRED** — the adversarial grade of that move, fired after it reports done, by a seat that did not do the work. Report at `reports/MOVE_OPTIN_AUDIT_20260921.md`; it grades, never repairs. |
