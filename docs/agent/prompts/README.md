...
| `C96_LIVE_FAILURE.md` | `prompt` | LIVE, executing: original repair failed in retail; rebuilt after identifying the wrong class registry at install, omitted availability gate and unsafe cargo credit. Owner permits autonomous design/implementation. Desk regression passes; restart, expedition launch/return and evidence close-out remain. |
