...
| `DLC_DEEP_CHECK_REWRITE_medium.md` | `prompt` | rewrite `DLC_DEEP_CHECK.md` to the current brief style: same job, free rein for its investigation links, no model names, chain mechanics cited from `support/CHAIN_METHOD.md`; consumed when it fires |
