...
| `GAME_PATCH_INSTRUMENTS_high.md` | `prompt` | live one-off investigation, authored 2026-09-18 (owner ask): design the surface sweep for the future perma `GAME_PATCH_PROMPT.md` (no, scoped or full deep sweep), the desk tools and in-game TestKit items behind it, backtested on 1.0.7 → 1.1.0; design only, no build |
