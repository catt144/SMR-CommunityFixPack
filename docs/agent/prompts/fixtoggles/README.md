...
17. **Bindings in force:** `editor/version rail (agent/prompts/perma/release_prompt.md § Release rails)` (no Mod Editor, no `version` edit, no upload), `H-03`, `H-04`, `H-08`, `H-09`,
