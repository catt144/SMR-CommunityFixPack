...
| 03 | `03_HARMS.md` | Opus | ✅ no | the applies-today repairs on modules that SURVIVE: F-1 probe-gate + save re-base, **F-2 exemption clause — RULED FIX by ck124, no longer conditional**, F-3 delete half (a). All three actionable; runs as one pass |
