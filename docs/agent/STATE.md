...
- **Owner decisions open: 3** — F85 severity (item 5) · status-vocab word (rec: LEAVE, in 26b) · rescue family-prefix rename (defaulted, release prep). ✅ 08-13: 22d APPROVED+APPLIED (9a) · 22c YES → prompt 5 · relabel CLOSED via item 22. ✅ 08-13: **26 STRUCK — tick
