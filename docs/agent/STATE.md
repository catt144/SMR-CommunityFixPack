...
- **Owner decisions (16 open — 4 NEW 2026-08-05: F48 unblock, D07 forced-dome,
  F101 severity, D12 preflight)** → `docs/PLAYTEST_CHECKLIST.md` "Decisions
  waiting on you", never only in agent docs. Relabel wording OWED.
