...
# Bug index — 160 rows, 125 entry files

102 F + 12 D + 46 C. `seq` is the entry's position in the old BUGS.md file order;
...
| 110 | D13 | Save-exit deliverables: uninstall procedure + standalone save-rescue artifact | directed | dsgn | high | [D13.md](D13.md) |
