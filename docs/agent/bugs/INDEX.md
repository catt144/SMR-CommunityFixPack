...
# Bug index — 155 rows, 120 entry files

100 F + 12 D + 43 C. `seq` is the entry's position in the old BUGS.md file order;
...
| 7 | F07 | St. Elmo's Fire "free wisps" gives ~1/1000 power | fixed | P1 | high | [F07.md](F07.md) |
