...
**Retired from the 1.1.1 pack:** `Fix_NightShiftWork` and its load/editor registrations and TestKit probe requirements are removed. The status above records the historical fix, not a newly attended 1.1.1 result.

**SOURCE, archived 1.1.1.405907:** Lua/Units/Colonist.lua:2396-2403 uses the modular day window, consumed by the work-leaving decision in Idle at :2561.
