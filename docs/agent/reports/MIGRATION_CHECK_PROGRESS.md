...
- DONE — S1/1: force_leave suppresses home scoring; graph bypasses the old cache filter.
- DONE — S1/2: TryToEmigrateToDome; seven rewrite changes retained, passage threshold persists.
- DONE — S1/3: UpdateResidence; stand-alone home must match community, ui_working remains.
- DONE — S1/4: ChooseResidence; comfort tiers added, ui_working remains.
- DONE — S1/5: CanReserveResidence; generalized IsSuitable check.
- DONE — S1/6: CancelResidenceReservation; also clears expedition hold.
- DONE — S1/7: GatherFreeLivingSpaces; parent-dome gate and filter buckets added.
- DONE — S2/1: ShuttleTransportCache PARTIAL; stale cache proven, old permanent-block claim weakened.
- DONE — S2/2: VacuumWalks PARTIAL; passage controls held, no-passage safety not supplied.
- DONE — S2/3: ArrivalDeaths PARTIAL; C83 witness kept separate from F53/F117 limits.
...
close-out; it must not be mistaken for a reliable timestamped history of progress.
