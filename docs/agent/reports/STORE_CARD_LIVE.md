...
(owner, same day). The owner then re-ordered the Paradox block by hand, mirrored into every
copy: SOME OF WHAT IT FIXES, BUGS QUESTIONS AND MODDING, the two FEATURED sections (the silent
machines now titled FEATURED too), HOW IT WORKS last; the fix-list URL is gone, since the site
link reaches it; sections sit one blank line apart. Shipped body: **5,015**
