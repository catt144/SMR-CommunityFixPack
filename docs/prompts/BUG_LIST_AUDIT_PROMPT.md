...
**Paste into a fresh session. One-off: consumed when `docseports\BUG_LIST_AUDIT.md`
...
- **ChoGGi's collection** — already cloned/subscribed locally (~471 mod folders,
  ...
  (**215 orig-capture references** counted in `docs\reports\PRIOR_ART_SURVEY.md`), so
...
`docs\agent\FIX_POLICY.md` (**§4a**, and the **drafted §4 amendment** at the end of
`docs\reports\REACHABILITY_AUDIT.md` — its "hard tells" are the vocabulary this audit
should use) · `docs\reports\REACHABILITY_AUDIT.md` "Challenge review 2026-07-30" (why
source is near-mute on *wrongness*) · `docs\reports\PRIOR_ART_SURVEY.md` ·
`docs\archive\RESEARCH.md`.

## Deliverable — `docseports\BUG_LIST_AUDIT.md`, committed
