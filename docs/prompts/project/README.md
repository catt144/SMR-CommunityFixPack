...
| 6c | `6c_residual_candidate_sweeps_part2_opus.md` | Opus | no | 6b's remaining three: C26-C30 Relaunched-presence checks (five candidates), F82 trace, F80 source-audit — carrying 6b's label-mechanism lead, which suggests C27/C28/C29 may all be the C22/C38 empty-label class |
